export const portfolios = [
  ...
  },
  {
    ...
    parrafo:
      "Tienda de perifericos, multipagina, con posibilidad de añadir productos a un carrito y proceder con el posible pago.",
    title: "Periféricool",
    tech: [
      "TypeScript",
      "React",
  ...
  },
  {
    ...
    parrafo:
      "App sobre raza de perros que incluía: búsquedas, filtrados combinados, ordenamientos y crud",
    title: "Wiki Perri",
    tech: [
      "JavaScript",
      "React",
  ...
  },
  {
    ...
    parrafo:
      "Página enfocada hacia un estudio de tatuajes, con diferentes secciones artísticas relacionadas con el tatuador y de turnos mediante Instagram o WhatsApp.",
    title: "Tattoo Studio",
    tech: [
      "TypeScript",
      "React",
